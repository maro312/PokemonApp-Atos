...
{
    /// <summary>
    /// Transforms a Results's type from a source type to a destination type. If the Results is successful, the func parameter is invoked on the Results's source value to map it to a destination type.
    /// </summary>
